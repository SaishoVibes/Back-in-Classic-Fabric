...
import com.backinclassic.asm.helper.ASMHelper;
		...
		for(MethodNode mNode : cNode.methods)
		{
			if(mNode.name.equals("func_70016_h") || mNode.name.equals("setVelocity"))
			{
				...
				if(mNode.desc.equals("(DDD)V"))
				{
					...
					hook.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/backinclassic/HookEntity", "setVelocity", "(Lnet/minecraft/entity/Entity;DDD)V", false));
