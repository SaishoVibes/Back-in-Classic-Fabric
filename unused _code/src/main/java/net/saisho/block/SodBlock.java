...
public class SodBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:sod_block")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("back_in_classic:crushed_gravel_match"),
			...
			event.getRegistry().register(feature.setRegistryName("crushed_gravel"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("back_in_classic:crushed_gravel"), configuredFeature);
		}
	}
	@SubscribeEvent
