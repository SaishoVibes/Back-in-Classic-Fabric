...
public class HealingCauldronBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:health_cauldron")
	public static final Block block = null;
	public HealingCauldronBlock(BackInClassicModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("health_cauldron");
		}
