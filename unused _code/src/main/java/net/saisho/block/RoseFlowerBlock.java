...
public class RoseFlowerBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:rose_flower")
	public static final Block block = null;
	public RoseFlowerBlock(BackInClassicModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rose_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("back_in_classic:rose_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
