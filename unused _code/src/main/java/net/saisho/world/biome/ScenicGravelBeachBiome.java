...
public class ScenicGravelBeachBiome extends BackInClassicModElements.ModElement {
	public static Biome biome;
	public ScenicGravelBeachBiome(BackInClassicModElements instance) {
		super(instance, 70);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("back_in_classic:scenic_gravel_beach"));
			}
		}
	}
	@Override
