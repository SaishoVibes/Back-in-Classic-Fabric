...
public class NetherPortalKeyKeyBinding extends BackInClassicModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;
	public NetherPortalKeyKeyBinding(BackInClassicModElements instance) {
		super(instance, 34);
	...
	public void initElements() {
		keys = new KeyBinding("key.back_in_classic.nether_portal_key", GLFW.GLFW_KEY_F9, "key.categories.misc");
		...
		if (type == 1) {
			{
				...
				NetherPortalSpawnCommandExecutedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
