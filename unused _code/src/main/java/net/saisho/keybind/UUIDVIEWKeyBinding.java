...
public class UUIDVIEWKeyBinding extends BackInClassicModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;
	public UUIDVIEWKeyBinding(BackInClassicModElements instance) {
		super(instance, 87);
	...
	public void initElements() {
		keys = new KeyBinding("key.back_in_classic.uuidview", GLFW.GLFW_KEY_I, "key.categories.misc");
		...
		if (type == 1) {
			{
				...
				UUIDVIEWOnKeyReleasedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
