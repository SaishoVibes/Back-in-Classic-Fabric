...
public interface BackInClassicBlocks {
    ...
    // FLOWER POTS
    Block POTTED_RED_ROSE = createBlock("potted_red_rose", new FlowerPotBlock(RED_ROSE, FabricBlockSettings.copyOf(Blocks.POTTED_RED_TULIP)));
    Block POTTED_BLUE_ROSE = createBlock("potted_blue_rose", new FlowerPotBlock(BLUE_ROSE, FabricBlockSettings.copyOf(Blocks.POTTED_RED_TULIP)));
    Block POTTED_PAEONIA = createBlock("potted_paeonia", new FlowerPotBlock(PAEONIA, FabricBlockSettings.copyOf(Blocks.POTTED_RED_TULIP)));
    Block POTTED_SHRUB = createBlock("potted_shrub", new FlowerPotBlock(SHRUB, FabricBlockSettings.copyOf(Blocks.POTTED_RED_TULIP)));
