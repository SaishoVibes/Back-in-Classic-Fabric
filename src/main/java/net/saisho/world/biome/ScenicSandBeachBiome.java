...
public class ScenicSandBeachBiome extends BackInClassicModElements.ModElement {
	public static Biome biome;
	public ScenicSandBeachBiome(BackInClassicModElements instance) {
		super(instance, 69);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.TURTLE, 5, 1, 4));
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.BEACH).depth(-0.2f).scale(0.1f)
						.temperature(0.5f).downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("back_in_classic:scenic_sand_beach"));
			}
		}
	}
	@Override
