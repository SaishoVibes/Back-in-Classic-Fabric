...
public class HarmingCauldronBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:harm_cauldron")
	public static final Block block = null;
	public HarmingCauldronBlock(BackInClassicModElements instance) {
		super(instance, 17);
	}
