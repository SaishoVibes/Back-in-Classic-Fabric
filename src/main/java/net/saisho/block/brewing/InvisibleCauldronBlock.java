...
public class InvisibleCauldronBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:invis_cauldron")
	public static final Block block = null;
	public InvisibleCauldronBlock(BackInClassicModElements instance) {
		super(instance, 17);
	}
