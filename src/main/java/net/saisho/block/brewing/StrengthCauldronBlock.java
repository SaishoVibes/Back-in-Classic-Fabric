...
public class StrengthCauldronBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:strength_cauldron")
	public static final Block block = null;
	public StrengthCauldronBlock(BackInClassicModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("strength_cauldron");
		}
