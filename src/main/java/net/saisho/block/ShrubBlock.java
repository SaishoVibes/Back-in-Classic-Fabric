...
public class ShrubBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:shrub")
	public static final Block block = null;
	public ShrubBlock(BackInClassicModElements instance) {
		super(instance, 1);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					if ((dimensionType == World.OVERWORLD) && (Math.random() >= 0.95))
			...
			event.getRegistry().register(feature.setRegistryName("shrub"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("back_in_classic:shrub"), configuredFeature);
		}
	}
	@SubscribeEvent
