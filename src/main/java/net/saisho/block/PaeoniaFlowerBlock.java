...
import net.backinclassic.procedures.RoseFlowerPlantRightClickedProcedure;
...
public class PaeoniaFlowerBlock extends BackInClassicModElements.ModElement {
	@ObjectHolder("back_in_classic:paeonia_flower")
	public static final Block block = null;
	public PaeoniaFlowerBlock(BackInClassicModElements instance) {
		super(instance, 6);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("paeonia_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("back_in_classic:paeonia_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("paeonia_flower");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				RoseFlowerPlantRightClickedProcedure.executeProcedure($_dependencies);
			}
